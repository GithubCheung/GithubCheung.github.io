...
.defines(function() {
  ig.Entity.inject({
    ...
    fireMouseUp:function() {
      if (ig.input.released('click') && this.isMouseInside() && typeof(this.onMouseDown) == "function") {
          this.onMouseUp();
      }
    },

    fireMousePressed:function() {
      if (ig.input.state('click') && this.isMouseInside() && typeof(this.onMouseDown) == "function") {
          this.onMousePressed();
      }
    },
