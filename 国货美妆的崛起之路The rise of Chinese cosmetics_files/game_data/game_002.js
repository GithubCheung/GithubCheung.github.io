...
(function(t) {
    ...
    function i(t, e) {
        ...
        this.IS_STANDALONE = t.isStandalone,
        this.messenger = t.messenger,
        this.moduleReady = e || !1,
        this.appTimer = null,
    ...
    function s(t, e) {
        ...
        this.moduleReady = e ? e: !1, this.data = t.data || null, this.gameState = "resume", !t || !t.messenger) throw Error("No messenger passed to the Game module instance");
        this.messenger = t.messenger,
    ...
    function p(t, e) {
        ...
        this.eventTracking = t.eventTracking,
        this.initialHeight = t.initialHeight,
        this.appToken = t.appToken,
        this.state = {
            userId: null
        },
    ...
    function y(t) {
        ...
        this._targets = t.targets ? t.targets: [],
        this._callbacks = [],
        this._channels = [],
    ...
    function v(t, n, c, h, g) {
        ...
        this.Branding = new c(m, !1),
        this.GameBreak = new g(f, !1),
        this.Game = new s(f, !1),
        this.Award = new u(v, !1),
        this.User = new o(y, !1),
        this.Score = new p(this._addAppToken(v), !1),
        this.Friends = new l(y, !1),
        this.GameEvent = new d(y, !1),
    ...
    "indexOf" in Array.prototype || (Array.prototype.indexOf = function(t, e) {
        ...
        0 > e && (e += this.length),
        0 > e && (e = 0);
        for (var n = this.length; n > e; e++) if (e in this && this[e] === t) return e;
        return - 1
    }),
    ...
    "forEach" in Array.prototype || (Array.prototype.forEach = function(t, e) {
        for (var n = 0,
        i = this.length; i > n; n++) n in this && t.call(e, this[n], n, this)
    }),
    ...
    "every" in Array.prototype || (Array.prototype.every = function(t, e) {
        for (var n = 0,
        i = this.length; i > n; n++) if (n in this && !t.call(e, this[n], n, this)) return ! 1;
        return ! 0
    }),
    "some" in Array.prototype || (Array.prototype.some = function(t, e) {
        for (var n = 0,
        i = this.length; i > n; n++) if (n in this && t.call(e, this[n], n, this)) return ! 0;
        return ! 1
    }),
    function(t) {
        ...
        function h(t) {
            return d(function(e, n) {
                for (var i = 0,
                a = t.length; a > i; i++) u(t[i]).then(e, n)
            })
        }
        function g(t, e, n) {
        ...
        function w(t, e) {
            oe && ("object" == typeof process && "function" == typeof process.emit && u.nextTick.runAfter(function() { - 1 !== $(se, t) && (process.emit("unhandledRejection", e, t), re.push(t))
        ...
        function O(t) {
            ...
            function(t) {
                ...
                function(i, a, s) {
                    var r;
                    y(a) && "fulfilled" === (r = a.inspect()).state ? t[s] = r.value: (++e, f(a,
                    function(i) {
                        t[s] = i,
                        0 === --e && n.resolve(t)
                    },
        ...
        function D(t) {
            ...
            function(i, a, s) {
                ...
                function o() {
                    n--,
                    0 === n && e.reject(Error("Can't get fulfillment value from any promise, all promises were rejected."))
                }
                function l(t) {
                    e.notify({
                        index: s,
        ...
        X = function() {
            function t() {
                for (var t, i; n.next;) n = n.next,
                t = n.task,
                n.task = void 0,
                i = n.domain,
                i && (n.domain = void 0, i.enter()),
                e(t, i);
                for (; o.length;) t = o.pop(),
                e(t);
                a = !1
            }
            function e(e, n) {
        ...
        u.master = R,
        u.spread = M,
        g.prototype.spread = function(t, e) {
        ...
        g.prototype.timeout = function(t, e) {
            ...
            i = setTimeout(function() {
                e && "string" != typeof e || (e = Error(e || "Timed out after " + t + " ms"), e.code = "ETIMEDOUT"),
                n.reject(e)
            },
            t);
            return this.then(function(t) {
        ...
        u.nsend = u.nmcall = u.ninvoke = function(t, e) {
            ...
            i = c();
            return n.push(i.makeNodeResolver()),
            u(t).dispatch("post", [e, n]).fail(i.reject),
            i.promise
        },
    ...
    _.getJSONP = function() {
        ...
        n = {
            ...
            send: function(i) {
                ...
                s = n.set.data || 0; (i || a || s) && (t += /\?/.test(t) ? "&": "?", i && (t += s ? s + "=" + encodeURIComponent(i) : i, a && (t += "&")), a && (t += a + "=" + e));
    ...
    A.getBrandingConfig = function(t) {
        return new Promise(function(e) {
            return S.getBrandingConfig(t).then(e,
            function(t) {
                e(t),
    ...
    e.prototype.displayOnTop = function(t) {
        ...
        i = t.action,
        a = t.callback;
        e.setAttribute("id", "spilgames-splash-screen-sample"),
    ...
    n.prototype.get = function(t) {
        ...
        n = t.split("."), i = n.length, a = 0; i - 1 > a; a++) {
    ...
    n.prototype.put = function(t, e) {
        ...
        i = t.split("."), a = i.length, s = 0; a - 1 > s; s++) {
            var r = i[s];
            n[r] || (n[r] = {}),
            n = n[r]
        }
    ...
    n.prototype.update = function(t, e) {
        var n, i, a = null;
        return this.get(t) ? (n = "update", a = this.get(t)) : n = "new",
        this.put(t, e),
    ...
    i.prototype.init = function(t) {
        ...
        this.data && this.data.game && this.data.user && (this.appId = this.data.game.applicationId || null, this.appToken = this.data.user.appToken || null, this.token = this.data.user.token || null),
        this._setupEvents(),
    ...
    i.prototype._retryAppToken = function(t) { (t || this.appTimerDelay !== this.appDelayMax) && (t && !this.appError && (this.appTimerDelay = this.appDelayMin, this.appError = !0), this._unschedule(), t ? this._increaseDelay() : this._resetDelay(), this._scheduleRefresh())
    },
    ...
    i.prototype._getAppToken = function() {
        ...
        this.IS_MASTER && ("function" == typeof SpilGames ? SpilGames("api.account.getApplicationToken", _.addToken(this.token, {
            cache: !1,
            applicationId: this.appId
        }),
        function(n) {
            n.error || !n.appAuth.token ? t._postMessage({},
            void 0, "gameapi.apptoken.getAppTokenResponse") : (e.appToken = n.appAuth.token, t._postMessage({
    ...
    a.prototype.flagDirtyKey = function(t) { - 1 === this.gameState.dirtyKeys.indexOf(t) && (this.gameState.dirtyKeys.push(t), this.scheduleSyncState())
    },
    ...
    a.prototype.syncState = function() {
        ...
        for (var t, e = this.gameState.appId,
        ...
        s = 0, r = this, o = 0; i.length > o; o++) t = window.localStorage[i[o]],
        void 0 === t ? a.remove.push(i[o]) : (a.set[i[o]] = t, s = Math.max(t.length, s));
        if (i.length > 0) {
            var l = {
    ...
    s.prototype.isSiteLock = function() {
        var t = !0;
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        return this.data && this.data.portal && this.data.portal.siteId && 500 > this.data.portal.siteId && (t = !1),
        t
    },
    ...
    r.prototype.getLocalizedText = function(t, e) {
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        var n = t;
        return this.data && this.data.localization[this.activeLanguage] && this.data.localization[this.activeLanguage][t] && this.data.localization[this.activeLanguage][t].id && this.data.localization[this.activeLanguage][t].id === e && (n = this.data.localization[this.activeLanguage][t].text),
        n
    },
    o.prototype.init = function(t) {
        this._setLocale(t),
        this._setupEvents(),
        t && t.data && t.data.portal && t.data.portal.siteId && 500 > t.data.portal.siteId && "0" !== t.data.portal.siteId && (this.isAvailable = !0)
    },
    ...
    o.prototype.getUser = function(t) {
        ...
        function(t) {
            t && "function" == typeof t ? t("api.user.getExtended",
            function(t) {
        ...
        void 0, "gameapi.user.getUserResponse");
            ...
            e._postMessage(["log.gameapi.user.getUser", {
                origin: "slave",
    ...
    o.prototype._getLang = function(t) {
        ...
        },
        {
            siteid: 468,
            lang: "tr-TR"
        }], n = 0; e.length > n; n++) if (e[n].siteid === t) return e[n].lang;
        return ""
    },
    ...
    l.prototype.getFriends = function(t) {
        ...
        } else "function" == typeof t && (this.friendscallback = t),
        e._postMessage({},
        void 0, "gameapi.friends.getFriends"),
        e._postMessage(["log.gameapi.friends.getFriends", {
            origin: "slave"
        },
        null], null, "log")
    },
    ...
    p.prototype.submit = function(t) {
        ...
        } else this.messenger._postMessage(t, void 0, "gameapi.score"),
    ...
    u.prototype.submit = function(t) {
        ...
        } else this.messenger._postMessage(t, void 0, "gameapi.award"),
    ...
    c.prototype._setupEvents = function() {
        ...
        function(n) {
            ...
            function(n) { ! 0 === n && e.adRequested && (e.adRequested = !1, SpilGames("game.ad.accepted", !0), t._postMessage(!0, void 0, "ad.request.accepted"))
            }),
    ...
    c.prototype.isAvailable = function() {
        var t = !1;
        return this.data && this.data.portal && this.data.portal.siteId && 187 !== this.data.portal.siteId && 500 > this.data.portal.siteId && (t = !0),
        t
    },
    c.prototype.reward = function(t, e) {
        ...
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        t(),
        this.isMaster ? e() : (this._callbacks.resume = e, this.messenger._postMessage(void 0, void 0, "game.force.break"))
    },
    ...
    h.prototype.init = function(t) {
        ...
        this.configureInternalTracking(e, n, i),
    ...
    h.prototype.trackGamePlay = function(t) {
        ...
        return this._sendSETEvent("express", a, t),
    ...
    h.prototype.trackGameAPIEvent = function(t, e) {
        e.appid = this.gamePlayTracking.appid,
        e.domainname = this.gamePlayTracking.host,
        e.siteid = parseInt(this.siteId, 10),
        e.channelid = parseInt(this.channelId, 10);
    ...
    g.prototype.getLogo = function(t) {
        ...
        t && "object" == typeof t && (i = _.validateSchema(a, t), i.error && (n.error = i.error)),
        n
    },
    ...
    y.prototype._postMessage = function(t, e, n) {
        var i, a;
        i = _.isArray(t) && "function" == typeof t[t.length - 1] ? this._callbacks.push(t.pop()) - 1 : e,
        a = new f({
            type: n || "jslib",
            callbackId: i,
            data: t
    ...
    y.prototype._handleMessage = function(t) {
        var e, n, i, a, s = this,
        r = new f(t.data);
        if (r) if (e = r.type, n = r.callbackId, i = r.data, a = this._callbacks[n] || !1, this.IS_MASTER) switch (e) {
        case "jslib":
    ...
    v.prototype._addEventTracking = function(t) {
        var e = t || {};
        return e.eventTracking = this.__.EventTracking,
        e
    },
    v.prototype._addComponents = function(t) {
        var e = t || {};
        return e.components = this.__.components,
        e
    },
    v.prototype._addInitialHeight = function(t) {
        var e = t || {};
        return e.initialHeight = window.outerHeight - window.innerHeight,
        e
    },
    v.prototype._addAppToken = function(t) {
        var e = t || {};
        return e.appToken = this.AppToken,
        e
    },
    ...
    v.prototype._getTargets = function() {
        ...
        if (this.IS_MASTER) {
            for (var t = ["iframegame", "iframeGameState"], e = null, n = [], i = 0; t.length > i; i++) e = document.getElementById(t[i]),
            e && e.contentWindow && n.push(e.contentWindow);
            return n
        }
    ...
    v.prototype.loadAPI = function(t, e) {
        ...
        function r() {
            ...
            e = e || null,
            A.setupStandaloneMode(e,
            function(t) {
                p.__.dataStore._setCache(a(t)),
                i(t)
            })
        }
        function o() {
            ...
            function(t) {
                l && clearTimeout(l),
                t.isready ? s() : 5 > c ? (c++, setTimeout(o, 500)) : (_.log("GameAPI:checkMasterReady not ready but reached max wait"), s())
            })
        }
        var l, p = this,
        ...
        null], null, "log"), this.IS_STANDALONE ? r() : this.IS_MASTER ? A.getGameConfig().then(function(t) {
            A.getBrandingConfig(t).then(function(e) {
                t && !t.isError ? (t.branding = e.branding, t.localization = e.localization, p.__.dataStore._setCache(a(t))) : _.log("GameAPI gameConfig error: ", t.isError),
                i(t)
            })
